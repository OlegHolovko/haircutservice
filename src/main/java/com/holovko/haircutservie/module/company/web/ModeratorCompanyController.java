...
public class ModeratorCompanyController {
    ...
    public List<ModeratorCompanyDto> list(
        ...
        return moderatorCompanyService.list(
                    moderatorCompanyService.getCompanyRepository(),
                    currentPage,
                    pageSize,
                    sortBy,
                    direction
    ...
    public ModeratorCompanyDto getById(@PathVariable Long companyId) throws CompanyNotFoundException {
        return moderatorCompanyMapper.fromCompany(
                moderatorCompanyService.read(
                        moderatorCompanyService.getCompanyRepository(),
                        companyId
                )
        );
